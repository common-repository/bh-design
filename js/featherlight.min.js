...
jQuery(document).on( 'click', '.maintainaince-notice .notice-dismiss', function() {
    localStorage.bh_notification_is_dismissed = 1;
})

if(localStorage.bh_notification_is_dismissed == '1') {
	jQuery('.maintainaince-notice').hide();
}
